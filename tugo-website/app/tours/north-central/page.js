...
const acts = [
  ...
  },
  {
    ...
    body: "Two days on the road bring you to Zavkhan and Ikh-Uul — the home of Chuka, my western co-host. From his family camp, a two-day horse trek up into the high country, sleeping in tents under the peaks.",
...
const itinerary = [
  ...
  },
  {
    ...
    more: "We reach Ikh-Uul around midday and move in with Chuka — my co-host out west, who knows these mountains the way I know the central steppe. His family hosts us: their ger, their food, their kitchen. Over milk tea we sort out the horses for tomorrow.",
  },
  {
    n: "07", act: 1,
    ...
    d: "A full day on horseback up into the mountains with Chuka, to a tent camp high under the peaks. Fire, stew, stars.",
