...
export default function AraFestivalPage() {
  return (
    <div className="min-h-screen bg-night-950 flex items-center justify-center px-6">
      ...
      >
        ...
        <p className="text-sand-400 leading-relaxed mb-8">
          Full tour details coming soon. Experience Mongolia&apos;s traditional Ara festival — fermented mare&apos;s milk, nomadic celebrations, and the start of summer on the open steppe.
        </p>
