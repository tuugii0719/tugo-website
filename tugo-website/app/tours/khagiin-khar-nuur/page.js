    ...
    <div className="min-h-screen bg-night-950 flex items-center justify-center px-6">
      ...
      >
        ...
        <h1 className="font-display text-4xl md:text-5xl text-sand-100 mb-4">
          Horse Trek · Khagiin Khar Nuur
        </h1>
        <p className="text-sand-400 leading-relaxed mb-8">
          Full tour details coming soon. Five days on horseback into the Khan Khentii taiga to Khagiin Khar Nuur — a hidden alpine lake reachable only by horse. Two days riding in, a night camped on the shore, two days riding out.
        </p>
